...
boxplot(mtcars$mpg~mtcars$cyl,main= "Relación entre el Número de Cilindros y las Millas por Galón",
        ...
        notch=TRUE)
```
El diagrama de caja nos presenta distribución
